...
namespace GDGame.Actors
{
    internal class CheckpointTile : BasicTile
    {
        ...
        public CheckpointTile(string id, ActorType actorType, StatusType statusType, Transform3D transform, OurEffectParameters effectParameters, Model model, ETileType tileType) :
