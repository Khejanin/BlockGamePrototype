...
namespace GDGame.Utilities
{
        ...
        public JSONValue(JSONValue value)
        {
            ...
            switch (Type)
            {
                ...
                case JSONValueType.Object:
                    if (value.Obj != null) Obj = new JSONObject(value.Obj);
                    break;
    ...
    public class JSONArray : IEnumerable<JSONValue>
    {
        ...
        public JSONArray(JSONArray array)
        {
            ...
            foreach (JSONValue v in array.values) values.Add(new JSONValue(v));
        }
        ...
        public override string ToString()
        {
            ...
            if (values.Count > 0) stringBuilder.Remove(stringBuilder.Length - 1, 1);
            stringBuilder.Append(']');
        ...
        {
            JSONArray result = new JSONArray(lhs);
            foreach (JSONValue value in rhs.values) result.Add(value);
            return result;
        }
        ...
        {
            JSONObject tempObject = JSONObject.Parse("{ \"array\" :" + jsonString + '}');
    ...
    public class JSONObject : IEnumerable<KeyValuePair<string, JSONValue>>
    {
        ...
        public static JSONObject Parse(string jsonString)
        {
            ...
            for (int startPosition = 0; startPosition < jsonString.Length; ++startPosition)
            {
                ...
                switch (state)
                {
                    case JSONParsingState.Object:
                        if (jsonString[startPosition] != '{') return Fail('{', startPosition);

                        JSONValue newObj = new JSONObject();
                        if (currentValue != null) newObj.Parent = currentValue;
                        currentValue = newObj;
                    ...
                    case JSONParsingState.EndObject:
                        ...
                        if (currentValue.Parent == null) return currentValue.Obj;
                    ...
                    case JSONParsingState.Key:
                        ...
                        string key = ParseString(jsonString, ref startPosition);
                        if (key == null) return Fail("key string", startPosition);
                        keyList.Add(key);
                    ...
                    {
                        char c = jsonString[startPosition];
                        if (c == '"')
                    ...
                    case JSONParsingState.String:
                        string str = ParseString(jsonString, ref startPosition);
                        if (str == null) return Fail("string value", startPosition);
                    ...
                    case JSONParsingState.Number:
                        double number = ParseNumber(jsonString, ref startPosition);
                        if (double.IsNaN(number)) return Fail("valid number", startPosition);
                    ...
                    case JSONParsingState.Array:
                        ...
                        if (currentValue != null) newArray.Parent = currentValue;
