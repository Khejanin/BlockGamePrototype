...
namespace GDGame.Component
{
    public class EnemyMovementComponent : PathMovementComponent, ICloneable
    {
        ...
        protected override void MoveToNextPoint()
        {
            ...
            parent.MoveTo(true, Vector3.Up, movementTime / 2, Smoother.SmoothingMethod.Accelerate,
                LoopMethod.PingPongOnce, parent.Body);
            parent.ScaleTo(false, Vector3.One * 0.5f, movementTime / 2, Smoother.SmoothingMethod.Smooth,
                LoopMethod.PingPongOnce);
